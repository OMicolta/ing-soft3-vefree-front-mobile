...
export default class AcceptService extends Component {
  state = {
    visibleModal: null,
  };
  ...
  _renderModalContent = () => (
    <View style={styles.modalContent}>
      ...
      <TextInput value={""} placeholder={"Nombre"} style={styles.input} />
      <TextInput value={""} placeholder={"Cédula"} style={styles.input} />
      <View style={styles.modalContent}>
        {this._renderButton("Cancelar", () =>
          this.setState({ visibleModal: null })
        )}
        {this._renderButton("Aceptar", () =>
          this.setState({ visibleModal: null })
        )}
      </View>
    </View>
